...
const Home: FC = (): ReactElement => {
  return (
    <div className="text-white p-4">
      ...
      <p>
        My design philosophy is rooted in minimalism and clear communication. I believe that simplicity is key to
        creating memorable user experiences. By carefully curating every element of your website, I ensure that your
        message is effectively communicated to your audience. Together, we will build a website that not only captures
        attention but also drives results.
      </p>
      <h2>Using Cutting-Edge Technologies</h2>
      <p>
      ...
      the quality of my work speaks for itself, and I am confident it will inspire you to envision what we can create
      together.
      <h2>Client Satisfaction is my Priority</h2>
      <p>
      ...
      <h2>Beyond Web Design</h2>
      <p>
        In addition to my passion for web design, I am a full-fledged software engineer at Re:Build Manufacturing, where
        I create scalable solutions to bring manufacturing back to the United States. Outside of work, I find joy in my
